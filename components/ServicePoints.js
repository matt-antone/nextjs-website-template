...
function ServicePoints(props) {
  return (
    <div>
      <div className="block icon-point py-4">
        <div className="container">
          <div className="w-15 mx-auto">
            <img  loading="lazy" className="aos-init aos-animate" src="https://res.cloudinary.com/navalign/image/upload/q_auto:good/v1546980904/icon-financial-advice.svg" alt="" data-aos="zoom-in-down" data-aos-delay="400" src="https://res.cloudinary.com/navalign/image/upload/q_auto:good/v1546980904/icon-financial-advice.svg" />
          </div>
      ...
      <div className="block icon-point py-4">
        <div className="container">
          <div className="w-15 mx-auto">
            <img loading="lazy" className="aos-init aos-animate" src="https://res.cloudinary.com/navalign/image/upload/q_auto:good/v1546980908/icon-financial-planning.svg" alt="" data-aos="zoom-in-down" src="https://res.cloudinary.com/navalign/image/upload/q_auto:good/v1546980908/icon-financial-planning.svg" />
          </div>
          <h2 className="text-center">
      ...
      <div className="block icon-point py-4">
        <div className="container">
          <div className="w-15 mx-auto">
            <img loading="lazy" className="aos-init" src="https://res.cloudinary.com/navalign/image/upload/q_auto:good/v1546980918/icon-investment-services.svg" alt="" data-aos="zoom-in-down" src="https://res.cloudinary.com/navalign/image/upload/q_auto:good/v1546980918/icon-investment-services.svg" />
          </div>
          <h2 className="text-center">
